...
from inspect_ai.util._limit import token_limit as create_token_limit, LimitExceededError
                ...
                with create_token_limit(token_limit):
                    ...
                    while not state.completed:
                        ...
                        try:
                            ...
                            logger.warning(f"Message generated! {str(state.output.message.content)[:30]}...")
                            if state.output.stop_reason == "model_length":
                                raise LimitExceededError("Model context window exceeded")
                        ...
                        if state.output.message.tool_calls:
                            ...
                            if answer:
                                ...
                                logger.warning("No submission accepted!")
